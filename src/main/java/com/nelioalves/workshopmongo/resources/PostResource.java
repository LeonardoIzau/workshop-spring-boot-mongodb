...
public class PostResource {
	...
	public ResponseEntity<List<Post>> fullSearch(
		...
		Date _minDate = URL.convertDate(minDate, new Date(0L));
		Date _maxDate = URL.convertDate(maxDate, new Date());
		List<Post> posts = service.fullSearch(text, _minDate, _maxDate);
		return ResponseEntity.ok().body(posts);
	}
}
